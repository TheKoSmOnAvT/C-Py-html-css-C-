...
namespace WindowsFormsApp1
{
    ...
    {
        public ClassLibrary1.Residential_Real_Estate obj = null;
        public Residential(string Do = "Добавление", ClassLibrary1.Residential_Real_Estate obj = null)
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                obj = new ClassLibrary1.Residential_Real_Estate(t, textBox1.Text, cost, textBox3.Text);
